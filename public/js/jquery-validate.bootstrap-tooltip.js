    ...
    prototype: {
      defaultShowErrors: function() {
        ...
        $.each(_this.validElements(), function(index, value) {
          ...
          //MINH THEM VAO
          var id_attr = "#" + $(value).attr("id") + "1";
          $(id_attr).removeClass('glyphicon-remove formInvalid').addClass('glyphicon-ok formValid');
          $(id_attr).css('display', 'inline-block');
      ...
      applyTooltipOptions: function(element, message) {
        var options = {
          ...
          animation: $(element).data('animation') || false,     //GIANG FIX BUGS VALIDATE
